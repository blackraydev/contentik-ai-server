const getActivationTemplate = (link) => `
<html>
  <head>
        ...
        <td align="center">
          ...
          >
            ...
            <p style="font-size: 14px; font-weight: 500; text-align: center">
              Нажмите на эту кнопку - и ваша почта будет подтверждена
            </p>
            <a
              href="${link}"
              style="
            ...
            <p style="color: #9696a5; font-size: 12px; text-align: center">
              Если вы не регистрировались в сервисе Contentik AI, просто удалите это письмо
            </p>
          </div>
        </td>
      </tr>
...
module.exports = getActivationTemplate;
