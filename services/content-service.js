      ...
      messages: [
        {
          ...
          content:
            ...
            '1) Структура: Каждый текст должен иметь четкую структуру: вводную часть, основное тело и заключение, но не используй для них заголовки. Используй подзаголовки, списки и выделение ключевых моментов для улучшения читаемости. \n' +
